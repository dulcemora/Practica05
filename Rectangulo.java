...
public class Rectangulo {
     ...
     * @param base El parametro que representa la base con valor de 10
     * @param altura El parametro que representa la altura con valor de 20
     */
    public Rectangulo() {
	this.base = 10;
	this.altura = 20;
     ...
     *Nos devuelve los valores de la base y la altura.
     */
